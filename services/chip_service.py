...
# ===== Official TWSE / TPEx data source override =====
# 從這裡開始，法人與融資融券資料改用官方資料源：
# - TWSE 上市法人：TWSE T86
# - TWSE 上市融資融券：TWSE OpenAPI MI_MARGN
# - TPEx 上櫃法人：TPEx dailyTrade
# - TPEx 上櫃融資融券：TPEx margin balance
#
# 原本的 analyze_institution_signal / analyze_margin_signal 邏輯保留，
# 只把資料來源從 FinMind 換成官方批次資料。

from services.chip_service_official import (
    fetch_institution_data as fetch_institution_data,
    fetch_margin_data as fetch_margin_data,
)
